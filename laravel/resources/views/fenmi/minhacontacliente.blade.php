...
<body>
  ...
  <!-- Seções -->
  <a class="section" href="#"><span><i class="fas fa-user"></i> Meu Perfil</span><i class="fas fa-chevron-right"></i></a>
  ...
  <a class="section" id="logout-btn" href="{{ route('login') }}"><span><i class="fas fa-sign-out-alt"></i> Sair da Conta</span><i class="fas fa-chevron-right"></i></a>
