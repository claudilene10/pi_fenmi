...
<head>
  ...
  <link rel="stylesheet" href="CSS/Perfil_Profissional.css">
...
<body>
  <main>
   ...
   <!-- Botão configuração  -->
<div class="confi">
  <a href="{{ route('minhacontaprofissional') }}" class="voltar">
  ...
  <div class="profile-info">
    ...
    </div> <!-- Fim de .profile    informacao_Profissinal-->
    <div class="botoes">
      <a href="{{ route('informacao_Profissinal') }}" class="btn-editar" role="button">
    ...
    <section class="conquistas">
      <div class="card">
        <div class="section">
          ...
          <ul>
            <li>Instalação elétrica residencial</li>
            <li>Reparos em encanamento</li>
      ...
      <section class="conquistas">
        <div class="card">
          <div class="section">
            <h3>Sobre</h3>
            <p>Profissional com 5 anos de experiência em serviços residenciais. Atendimento rápido e de qualidade.</p>
          </div>
          <div class="section">
            <h3>Documentação</h3>
            <ul>
              <li>Identidade verificada ✔</li>
              <li>Certificação em elétrica ✔</li>
    ...
    <section id="avaliacoes">
      ...
      <div class="rating">⭐⭐⭐⭐⭐ 4.9 (150 avaliações)</div>
