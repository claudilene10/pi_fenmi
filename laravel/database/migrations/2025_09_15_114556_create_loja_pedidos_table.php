...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('lojaPedidos', function (Blueprint $table) {
            $table->id('id_pedido'); # PK do pedido
            $table->string('titulo', 150); # Ex: "Bem-Estar • Personal Trainer"
            ...
            $table->enum('status', ['novo', 'aceito', 'realizado'])->default('novo'); # Status do pedido
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('lojaPedidos');
    }
};
